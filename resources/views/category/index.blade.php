                                    ...
                                    @foreach($data['category'] as  $dt)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('category.edit', ['id' => $dt->id]) }}" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i></a>
                                                <a onclick="return confirm('Delete this data ?')" href="{{ route('category.delete', ['id' => $dt->id]) }}" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
